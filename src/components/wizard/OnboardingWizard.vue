...
const ollamaDefaults = getDefaultModels('ollama')
...
const formData = reactive({
  ...
  assistantModel: ollamaDefaults.assistantModel as string,
  summarizationModel: ollamaDefaults.summarizationModel as string,
