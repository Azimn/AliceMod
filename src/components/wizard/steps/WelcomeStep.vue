<template>
  <div class="h-full flex items-center justify-center py-4">
    <div class="w-full max-w-xl text-center">
      ...
      <h2 class="text-2xl font-semibold mb-3">Set up Kiki essentials</h2>
        ...
        <div class="bg-base-300/45 border border-gray-800 rounded-lg p-4">
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"
            />
          </svg>
